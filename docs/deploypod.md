...
If you are shifting a database to Cloud Pak for Data, then the cloned database must must have `db2inst1` as the
INSTANCE userid. See the section on Cloning a database to make sure that the proper authorities have been
